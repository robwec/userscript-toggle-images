...
function toggleBackgroundLink(alink)
{
    if ([undefined, null, NaN, ""].indexOf(alink.style["background-image"]) === -1
     || [undefined, null, NaN, ""].indexOf(alink.style.background) === -1
     || [undefined, null, NaN, "", "none"].indexOf(window.getComputedStyle(alink)['background-image']) === -1)
    {
        if (allowimages === true)
        {
